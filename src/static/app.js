document.addEventListener("DOMContentLoaded", () => {
              ...
              <ul class="participants-list" style="list-style-type: none; margin-left: 0; padding-left: 0;">
                ${details.participants.map(p => `
                  <li style="display: flex; align-items: center; gap: 6px;">
                    <span>${p}</span>
                    <span class="delete-participant" data-activity="${name}" data-email="${p}" title="Remove participant" style="cursor:pointer;color:#c62828;font-size:18px;line-height:1;">&#128465;</span>
                  </li>
                `).join("")}
              </ul>
            </div>
  ...
  // Delegar el click en el ícono de eliminar participante
